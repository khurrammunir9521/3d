...
<section class="sec-dashboard">
  <div class="container-fluid">
    <div class="row dashboard-row">
          ...
          <div class="card-header">
            <div class="header-top d-sm-flex align-items-center">
              ...
              <div class="center-content growth-content">
                <p class="d-flex align-items-center"><i class="toprightarrow-primary fa fa-arrow-up me-2"></i>80% Growth
                </p>
              </div>
        ...
        <div class="card latest-update-sec">
          <div class="card-header">
            <div class="header-top d-sm-flex align-items-center">
              ...
              <div class="center-content latest-content">
                <ul class="week-date">
      ...
      <!-- recent order -->
      <div class="col-md-4 recent-order-sec">
        <div class="card">
          <div class="card-body">
            <div class="table-responsive">
              <h5>Recent Orders</h5>
                  ...
                  <tr>
                    <td>
                      <div class="media"><img class="img-fluid rounded-circle"
                          src="../assets/images/dashboard/product-1.png" alt="" data-original-title="" title="">
                    ...
                    <td><img class="img-fluid" src="../assets/images/dashboard/graph-1.png" alt="" data-original-title=""
                        title=""></td>
                    <td>
                      <p>$210326</p>
                    </td>
