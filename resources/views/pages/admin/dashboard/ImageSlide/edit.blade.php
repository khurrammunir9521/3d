...
@section('content')
    <form method="POST" action="{{ route('image.update', $images->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="form-group">
            <label for="exampleInputEmail1">Speed </label>
            <input type="number" class="form-control" name="speed" id="" value="{{ $images->speed }}"
                aria-describedby="emailHelp" placeholder="Enterheading">
            <small id="" class="form-text text-muted"> </small>
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">Number </label>
            <input type="number" class="form-control" name="number" value="{{ $images->speed }}" id=""
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="heading" value="{{ $images->heading }}" id=""
                aria-describedby="" placeholder="Enter sub heading">
            <small id="" class="form-text text-muted"> </small>
        </div>
        ...
        <div class="form-group">
            <label for="exampleInputEmail1"> Heading </label>
            <input type="text" class="form-control" name="heading2" value="{{ $images->heading2 }}" id=""
                aria-describedby="" placeholder="Enter sub heading">
            <small id="" class="form-text text-muted"> </small>
        </div>
        ...
        <div class="form-group">
            <label for="exampleInputEmail1"> Heading </label>
            <input type="text" class="form-control" name="heading3" value="{{ $images->heading3 }}" id=""
                aria-describedby="" placeholder="Enter sub heading">
            <small id="" class="form-text text-muted"> </small>
        </div>
        ...
        <div class="form-group">
            <label for="exampleInputEmail1"> Heading </label>
            <input type="text" class="form-control" name="heading4" value="{{ $images->heading4 }}" id=""
                aria-describedby="" placeholder="Enter sub heading">
            <small id="" class="form-text text-muted"> </small>
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">Sub Heading </label>
            <input type="text" class="form-control" name="sub_heading" value="{{ $images->sub_heading }}" id=""
                aria-describedby="" placeholder="Enter sub heading">
            <small id="" class="form-text text-muted"> </small>
        </div>
        ...
        <div class="form-group">
            <label for="exampleInputEmail1">Sub Heading </label>
            <input type="text" class="form-control" name="sub_heading2" value="{{ $images->sub_heading2 }}" id=""
                aria-describedby="" placeholder="Enter sub heading">
            <small id="" class="form-text text-muted"> </small>
        </div>
        ...
        <div class="form-group">
            <label for="exampleInputEmail1">Sub Heading </label>
            <input type="text" class="form-control" name="sub_heading3" value="{{ $images->sub_heading3 }}" id=""
                aria-describedby="" placeholder="Enter sub heading">
            <small id="" class="form-text text-muted"> </small>
        </div>
        ...
        <div class="form-group">
            <label for="exampleInputEmail1">Sub Heading </label>
            <input type="text" class="form-control" name="sub_heading4" value="{{ $images->sub_heading4 }}" id=""
                aria-describedby="" placeholder="Enter sub heading">
            <small id="" class="form-text text-muted"> </small>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control" name="images" id="" accept="image/*" type="file"
                id="download-cv-file-name" name="images" id="images" value="{{ $images->images }}" aria-describedby=""
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control" name="images2" id="" accept="image/*" type="file"
                id="download-cv-file-name" name="images2" id="images2" value="{{ $images->images2 }}" aria-describedby=""
                placeholder="Enter sub heading">
            <small id="" class="form-text text-muted"> </small>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control" name="images3" id="" accept="image/*" type="file"
                id="download-cv-file-name" name="images3" id="images3" value="{{ $images->images3 }}" aria-describedby=""
                placeholder="Enter sub heading">
            <small id="" class="form-text text-muted"> </small>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control" name="images4" id="" accept="image/*" type="file"
                id="download-cv-file-name" name="images4" id="images4" value="{{ $images->images4 }}" aria-describedby=""
                placeholder="Enter sub heading">
            <small id="" class="form-text text-muted"> </small>
        </div>
