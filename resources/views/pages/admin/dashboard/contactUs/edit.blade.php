            ...
            <form method="POST" action="{{ route('contact.update', $contacts->id)
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <small id="" class="form-text text-muted">Describe your location
                    name </small>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="location_map"
                    value="{{$contacts->location_map}}"id="" aria-describedby=""
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  placeholder="Enter sub heading">
                  <small id="" class="form-text text-muted">Describe your heading
                  </small>
                </div>
