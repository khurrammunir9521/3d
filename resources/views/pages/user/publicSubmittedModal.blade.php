<div class="modal fade page result" id="publicSubmittedModal" tabindex="-1" aria-labelledby="publicSubmittedModalLabel" aria-hidden="true">
                ...
                <div class="row align-items-center">
                    <div class="col-md-5">
                        <div class="submitted-data">
                            ...
                            <p><img src="{{asset('user/assets/icons/red-circle.svg')}}" alt="red-circle"> الدفع</p>
                    ...
                    <div class="col-md-12">
                        <div class="form-action">
                            <button class="btn btn-form mx-3 with-arrow public-offerPrice" data-bs-toggle="modal" data-bs-target="#publicPaymentModal">عرض السعر</button>
