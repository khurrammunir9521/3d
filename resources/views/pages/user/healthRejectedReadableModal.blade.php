<div class="modal fade page result modal-final" id="healthRejectedReadableModal" tabindex="-1" aria-labelledby="healthRejectedReadableModalLabel" aria-hidden="true">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row text-center mb-5 final">
                                    ...
                                    <img src="{{asset('user/assets/icons/silver-line.svg')}}" alt="">
                                    <div class="col">
                                        <div class="dateTime small text-white">11/01/2022 - 03:00PM</div>
                                        <img src="{{asset('user/assets/icons/silver-circle.svg')}}" class="silver-circle" alt="silver-circle">
                                        <div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-action requests">
                                    <button class="btn btn-form mx-3 with-arrow complete-other" data-bs-toggle="modal" data-bs-target="#otherLoaderModal">طلباتي</button>
