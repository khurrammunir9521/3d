 <div class="modal fade page result modal-final" id="stageOneFinalModal" tabindex="-1" aria-labelledby="stageOneFinalModalLabel" aria-hidden="true">
                         ...
                         <div class="row">
                             <div class="col-md-12">
                                 <div class="form-action requests">
                                     <button class="btn btn-form mx-3 with-arrow">تفاصيل الطلب</button>
