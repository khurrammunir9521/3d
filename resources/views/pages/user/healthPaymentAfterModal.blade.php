 <div class="modal fade page" id="healthPaymentAfterModal" tabindex="-1" aria-labelledby="healthPaymentAfterModalLabel" aria-hidden="true">
                 ...
                 <div class="row">
                     <div class="col-md-12">
                         ...
                         <div class="modal-footer">
                             <div class="row">
                                 <div class="col-md-12">
                                     <div class="form-action order-details">
                                         <button class="btn btn-form mx-3 with-arrow orderDetails-btn">تفاصيل الطلب</button>
                                         <button class="btn btn-sky mx-3 p" type="submit" data-bs-toggle="modal" data-bs-target="#healthPaymentResultModal">الفاتورة</button>
