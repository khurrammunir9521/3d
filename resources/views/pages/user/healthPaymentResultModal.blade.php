  <div class="modal fade page result" id="healthPaymentResultModal" tabindex="-1" aria-labelledby="healthPaymentResultModalLabel" aria-hidden="true">
                          ...
                          <div class="row">
                              <div class="col-md-12">
                                  <div class="form-action requests">
                                      <button class="btn btn-form mx-3 with-arrow showHealthRequests" data-bs-toggle="modal" data-bs-target="#requestsModal">طلباتي</button>
