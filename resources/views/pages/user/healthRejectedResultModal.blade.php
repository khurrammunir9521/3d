  <div class="modal fade page result-modal" id="healthRejectedResultModal" tabindex="-1" aria-labelledby="healthRejectedResultModalLabel" aria-hidden="true">
                                  ...
                                  <div class="col-md-7">
                                      ...
                                      <div class="left-content">
                                          ...
                                          <div>
                                              ...
                                              <img src="{{asset('user/assets/icons/silver-circle.svg')}}" alt="">
                                          </div>
                                          <div>
                                              <p>اختبار الجودة</p>
                                              <img src="{{asset('user/assets/icons/silver-circle.svg')}}" alt="">
                              ...
                              <div class="row">
                                  <div class="col-md-12">
                                      <div class="form-action">
                                          <button class="btn btn-form mx-3 with-arrow" type="submit" data-bs-toggle="modal" data-bs-target="#healthRejectedReadableModal">عرض السعر</button>
