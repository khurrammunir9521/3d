                    ...
                    <div class="col-md-12">
                        ...
                        <div class="modal-body">
                            ...
                            <form class="gy-4 gx-5" method="post" action="{{route('edituser_profile',auth()->user()->id)}}">
                                ...
                                <img id="blah1" src="{{asset('user/assets/icons/edit-avatar.svg')}}" class="mx-auto d-block imageupload1" width="100" alt="avatar" style="clip-path: circle() !important ;height: 100% !important;" alt="dashboard_logo" />
                                @else
                                <img id="blah1" src="{{ asset('storage/' . Auth::user()->profile) }}" alt="dashboard_logo" class="mx-auto d-block imageupload1" style="clip-path: circle() !important ;height: 100% !important;" width="100" />
                                @endif
                                @endauth
