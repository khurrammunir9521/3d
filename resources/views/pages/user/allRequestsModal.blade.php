<div class="modal fade page" id="allRequestsModal" tabindex="-1" aria-labelledby="allRequestsModalLabel" aria-hidden="true">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-action">
                                        <button class="btn btn-form mx-3 with-arrow" type="submit" data-bs-toggle="modal" data-bs-target="#allRequestsResultModal">عرض السعر</button>
